...
{
    public static ServerNetPortal Instance;
    ...
    public void OnNetworkReady()
    {
        ...
        else
        {
            ...
            //TODO get the lobbymanager and enable/disable the appropriate ui elements
    ...
    private void ApprovalCheck(byte[] connectionData, ulong clientId, NetworkManager.ConnectionApprovedDelegate connectionApprovedCallback)
    {
        ...
        {
            Debug.Log("Host ApprovalCheck: connecting client GUID: Host");
